...
log_file = os.path.join(dir, 'log_DIF++_%s.txt' % (args.target_domain))
...
def train_model(args):
    ...
    [user_train_target_domain, user_valid_target_domain, user_test_target_domain,
     ...
     user_neg_target_domain, ItemFeatures, MetaFeatures] = dataset
    ...
    model = Model(itemnum_target_domain, ItemFeatures, MetaFeatures, args).to(args.device)
        ...
        for epoch in range(epoch_start_idx, args.num_epochs + 1):
            ...
            if epoch % args.eva_interval == 0:
                ...
                if epoch == args.num_epochs and args.save_model == 1:
                    fname = 'DIF++.epoch={}.lr={}.layer={}.head={}.hidden={}.maxlen={}.pth'
